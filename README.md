...
| | |
|---|---|
| **Health check** | https://inspectiq-agent-fyo6xgoawq-uc.a.run.app/health |
| **HTML Report** | https://inspectiq-agent-fyo6xgoawq-uc.a.run.app/demo-report |
| **Interactive API docs** | https://inspectiq-agent-fyo6xgoawq-uc.a.run.app/docs |
| **Demo JSON** | https://inspectiq-agent-fyo6xgoawq-uc.a.run.app/demo-result |
